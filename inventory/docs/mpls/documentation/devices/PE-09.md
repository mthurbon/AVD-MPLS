...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.109/24 | 192.168.0.6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2/1 | - | - | 1.1.1.5/31 | groq-inside | - | False | - | - |
| Ethernet3/1 | P2P_RR-03_Ethernet9/1 | - | 192.168.12.11/31 | default | 2000 | False | - | - |
| Ethernet4/1 | P2P_PE-04_Ethernet9/1 | - | 192.168.12.19/31 | default | 2000 | False | - | - |
| Ethernet10/1 | P2P_PE-10_Ethernet9/1 | - | 192.168.12.24/31 | default | 2000 | False | - | - |
...
interface Ethernet3/1
   description P2P_RR-03_Ethernet9/1
   no shutdown
   mtu 2000
   no switchport
...
interface Ethernet4/1
   description P2P_PE-04_Ethernet9/1
   no shutdown
   mtu 2000
   no switchport
...
interface Ethernet10/1
   description P2P_PE-10_Ethernet9/1
   no shutdown
   mtu 2000
   no switchport
   ip address 192.168.12.24/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.9/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0100.0100.0009.00 |
| Type | level-2 |
| Router-ID | 10.1.0.9 |
...
!
router isis CORE
   net 49.0001.0100.0100.0009.00
   router-id ipv4 10.1.0.9
   is-type level-2
...
| 1.1.1.4 | 65800 | groq-inside | - | extended | - | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| groq-inside | 10.1.0.9:800 | connected | - |
...
router bgp 65900
   ...
   vrf groq-inside
      ...
      router-id 10.1.0.9
      neighbor 1.1.1.4 remote-as 65800
      neighbor 1.1.1.4 description to-CE-02

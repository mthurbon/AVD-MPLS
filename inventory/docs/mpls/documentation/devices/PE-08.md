...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.108/24 | 192.168.0.6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | - | - | 1.1.1.3/31 | groq-inside | - | False | - | - |
| Ethernet3 | P2P_RR-03_Ethernet8/1 | - | 192.168.12.8/31 | default | 2000 | False | - | - |
| Ethernet4 | P2P_PE-04_Ethernet8/1 | - | 192.168.12.6/31 | default | 2000 | False | - | - |
| Ethernet7 | P2P_PE-07_Ethernet8 | - | 192.168.12.5/31 | default | 2000 | False | - | - |
...
!
interface Ethernet3
   description P2P_RR-03_Ethernet8/1
   no shutdown
   mtu 2000
   no switchport
...
!
interface Ethernet4
   description P2P_PE-04_Ethernet8/1
   no shutdown
   mtu 2000
   no switchport
...
!
interface Ethernet7
   description P2P_PE-07_Ethernet8
   no shutdown
   mtu 2000
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.8/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0100.0100.0008.00 |
| Type | level-2 |
| Router-ID | 10.1.0.8 |
...
!
router isis CORE
   net 49.0001.0100.0100.0008.00
   router-id ipv4 10.1.0.8
   is-type level-2
...
| 1.1.1.2 | 65800 | groq-inside | - | extended | - | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| groq-inside | 10.1.0.8:800 | connected | - |
...
router bgp 65900
   ...
   vrf groq-inside
      ...
      router-id 10.1.0.8
      neighbor 1.1.1.2 remote-as 65800
      neighbor 1.1.1.2 description to-CE-01
